...
def main():
    random.seed(4501)
    lst_pairs = []
    keys = ['TimePeriod', 'ReceiverTissueID', 'ReceiverBloodType', 'ReceiverPRA', 'ReceiverSurvivalPrb', 'DonorTissueID', 'DonorBloodType']
